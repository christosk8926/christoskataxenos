...
<Terminal title="bash"> $ gcc main.c -o main Error: 'gcc' is not recognized as an internal or external command. PATH is currently pointing to: C:\EAP\PLH10\WHY_ME
...
<Callout type="success" title="Δοκιμάστε το"> 🔗 Link: Ψευδογλώσσα Interpreter </Callout>
